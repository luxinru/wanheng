  ...
  <div>
    <div class="user_n1">
      ...
      <div v-if="type == '3'">
        ...
        <div class="btnBox">
          <!-- <div class="everybtn left" @click="toBox('转出到余额', '0')">
            转出
          </div> -->
          <div class="everybtn right" @click="toBox('转入到宝库', '1')">
            转入
          </div>
        </div>
      </div>
      ...
      <div class="fixedBox" v-if="type == '0'">
        ...
        <div class="fixedBox_title">请输入转出金额</div>
        <div class="inpuBox">
      ...
      <div class="fixedBox" v-if="type == '1'">
        ...
        <div class="fixedBox_title">请输入转入金额</div>
        <div class="inpuBox">
...
.btnBox {
  ...
  .everybtn {
    width: 166px;
    height: 44px;
    background: rgba(255, 137, 53, 0.20000000298023224);
...
.user_n1 {
  width: 100%;
  background-image: url("~@/assets/wanheng/宝库转入_slices/组 7@2x.png");
  background-size: 100%;

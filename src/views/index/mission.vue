<template>
	<div class="index-container">
		...
		<div class="index-content">
            <!-- <div class="index-content-title"></div> -->
			...
			<div class="task-list-box">
                <div class="task-list-item">
                    ...
                    <div class="task-list-item-right" :class="{'active-btn': mission.qiandao_status}" @click="checkin2()">{{mission.qiandao_status ? '已完成' : '去完成'}}</div>
                </div>
				<div class="task-list-item">
					<div class="task-list-item-left">
						...
						<div class="item-title-box">
                            ...
                            <div class="item-sub-title">一起健康运动</div>
                        </div>
					</div>
					<div class="task-list-item-right" :class="{'active-btn': mission.invest_status == true}" @click="handleTaskListItem(1)">{{mission.invest_status == true ? '已完成' : '去完成'}}</div>
				</div>
				<!--
...
<!-- 				<div class="task-list-item">
					...
					<div class="task-list-item-right" :class="{'active-btn': mission.yue_bao_status == true}" @click="handleTaskListItem(2)">{{mission.yue_bao_status == true ? '已完成' : '去完成'}}</div>
				</div> -->
				...
				<div class="task-list-item">
					...
					<div class="task-list-item-right" :class="{'active-btn': mission.auth_status == true}" @click="handleTaskListItem(3)">{{mission.auth_status == true ? '已完成' : '去完成'}}</div>
				</div>
<!-- 
				<div class="task-list-item">
					<div class="task-list-item-left">
 ...
 -->
				<div class="task-list-item">
					...
					<div class="task-list-item-right" :class="{'active-btn': mission.answer_status}" @click="handleTaskListItem(6)">{{mission.answer_status ? '已完成' : '去完成'}}</div>
				</div>
				<!--
				<div class="task-list-item-bank"><img src="./../../assets/images/qianhai/task/line.png" width=100% /></div>
				<div class="task-list-item">

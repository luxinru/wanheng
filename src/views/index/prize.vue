...
.head{
    ...
    .container {
        width: 100vw;
        background: red url("./image/bk.png");
        background-size: 100%;
        ...
        .wheel-bg {
            width: 305px;
            height: 305px;
            background: url(./image/dipan.png) no-repeat center top;
            background-size: 100%;
            color: #fff;
            font-weight: 500;
            display: flex;

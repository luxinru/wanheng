<template>
  <div class="container">
    ...
    <div class="main">
      <div class="contents">
        <p>今日剩余： {{ lottery_ticket }}</p>
      </div>
      <div class="remark" v-html="prize_remark"></div>
      <!-- <div class="jl">
                <p>
                    <router-link to="/" class="zjjl">返回首页&gt;&gt;</router-link>
                    <router-link to="/kefu" class="zjjl">在线客服&gt;&gt;</router-link>
                    <span @click="dialog">活动规则&gt;&gt;</span>
                </p>
            </div> -->
      <div class="gdbox">
        <div class="strongs">中奖记录</div>
        <p class="tit">
          <span>手机号</span>
          <span>获得奖励</span>
        </p>
  ...
  methods: {
    ...
    dialog () {
      Dialog.alert({
        title: '规则介绍',
        message:
          '1.每日可抽奖3次，第一次免费赠送抽奖机会，第二、第三次可使用188积分进行抽奖；\n2.如获得现金奖励，抽奖结束后自动派送至会员账户余额，可点击会员中心-资金明细查看详情；\n3.如获得实体物品，抽奖结束后主动联系客服人员，提供快递信息，由于实体礼品涉及采购时间，所以奖品会在抽奖结束后20个工作日内寄出；',
        className: 'cj_dialog'
      }).then(() => {
...
.container {
  width: 100vw;
  background: red url('~@/assets/wanheng/转盘_slices/组 11@2x.png');
  background-size: 100%;
  ...
  .gdbox > .strongs {
    ...
    color: #FFFFFF;
    line-height: 20px;
    -webkit-text-stroke: 1px #640701;
    text-stroke: 1px #640701;
    margin: 10px auto 0;
    display: flex;
    align-items: center;
    justify-content: center;
  ...
  .contents {
    ...
    color: #ffeb39;
    margin-bottom: 15px;
    background: url('./image/cishu.png') no-repeat center top;
    background-size: 100%;
    width: 215px;
    height: 84px;
    text-align: center;

<template>
  <div class="investment-container">
    <div class="investment-list-box" v-for="item in data" :key="item.id" @click="handleGoDetail(item)">
      <div class="investment-list-info">
        <!-- <div class="project-tag-box">
          <div class="project-tag">保本保息</div>
        </div> -->
        <div class="project-name">
          <span>{{ item.apr_plan[0].title }}</span>
        ...
        <section>
          ...
          <div class="project-btn">
            ...
            <!-- <div class="project-money-right" @click="handleGoDetail(item)">
              查询详情
            </div> -->
          </div>
        </section>

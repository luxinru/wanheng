<template>
  <div class="item-container">
    ...
    <div class="index-head">
      <van-swipe :autoplay="5000" indicator-color="#fff" style="width: 100%;height: 100%;">
    ...
    <div class="item-content-box">
      ...
      <InvestItem v-for="item in list" :key="item.id" @click.native="goToDetail(item.id)" :invest-info="item"></InvestItem>
    </div>
  </div>
</template>
